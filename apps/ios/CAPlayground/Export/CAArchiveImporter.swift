...
private final class CAMLImporter: NSObject, XMLParserDelegate {
    ...
    private func beginEmitterCell(_ elementName: String, _ parent: String?, _ attributes: [String: String]) -> Bool {
        ...
        currentEmitterCell = .init(
            ...
            birthRate: number(attributes["birthRate"]) ?? 0,
            lifetime: number(attributes["lifetime"]) ?? 0,
            lifetimeRange: number(attributes["lifetimeRange"]) ?? 0,
            velocity: number(attributes["velocity"]) ?? 0,
            velocityRange: number(attributes["velocityRange"]) ?? 0,
            ...
            emissionRange: (number(attributes["emissionRange"]) ?? 0) * radiansToDegrees,
            scale: number(attributes["scale"]) ?? 1,
            scaleRange: number(attributes["scaleRange"]) ?? 0,
            ...
            alphaSpeed: number(attributes["alphaSpeed"]) ?? 0,
