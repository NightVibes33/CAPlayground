...
struct EmitterCellModel: Codable, Hashable, Identifiable {
    ...
    init(id: UUID = UUID(), name: String = "Particle", imageName: String? = nil, contentsScale: Double = 1, birthRate: Double = 0, lifetime: Double = 0, lifetimeRange: Double = 0, velocity: Double = 0, velocityRange: Double = 0, emissionLongitude: Double = 0, emissionLatitude: Double = 0, emissionRange: Double = 0, scale: Double = 1, scaleRange: Double = 0, scaleSpeed: Double = 0, alpha: Double = 1, alphaRange: Double = 0, alphaSpeed: Double = 0, spin: Double = 0, spinRange: Double = 0, xAcceleration: Double = 0, yAcceleration: Double = 0, color: String = "#FFFFFF", redRange: Double = 0, redSpeed: Double = 0, greenRange: Double = 0, greenSpeed: Double = 0, blueRange: Double = 0, blueSpeed: Double = 0) {
    ...
    init(from decoder: Decoder) throws {
        ...
        id=try c.decodeIfPresent(UUID.self,forKey:.id) ?? UUID(); name=try c.decodeIfPresent(String.self,forKey:.name) ?? "Particle"; imageName=try c.decodeIfPresent(String.self,forKey:.imageName); contentsScale=try c.decodeIfPresent(Double.self,forKey:.contentsScale) ?? 1; birthRate=try c.decodeIfPresent(Double.self,forKey:.birthRate) ?? 0; lifetime=try c.decodeIfPresent(Double.self,forKey:.lifetime) ?? 0; lifetimeRange=try c.decodeIfPresent(Double.self,forKey:.lifetimeRange) ?? 0; velocity=try c.decodeIfPresent(Double.self,forKey:.velocity) ?? 0; velocityRange=try c.decodeIfPresent(Double.self,forKey:.velocityRange) ?? 0; emissionLongitude=try c.decodeIfPresent(Double.self,forKey:.emissionLongitude) ?? 0; emissionLatitude=try c.decodeIfPresent(Double.self,forKey:.emissionLatitude) ?? 0; emissionRange=try c.decodeIfPresent(Double.self,forKey:.emissionRange) ?? 0; scale=try c.decodeIfPresent(Double.self,forKey:.scale) ?? 1; scaleRange=try c.decodeIfPresent(Double.self,forKey:.scaleRange) ?? 0; scaleSpeed=try c.decodeIfPresent(Double.self,forKey:.scaleSpeed) ?? 0; alpha=try c.decodeIfPresent(Double.self,forKey:.alpha) ?? 1; alphaRange=try c.decodeIfPresent(Double.self,forKey:.alphaRange) ?? 0; alphaSpeed=try c.decodeIfPresent(Double.self,forKey:.alphaSpeed) ?? 0; spin=try c.decodeIfPresent(Double.self,forKey:.spin) ?? 0; spinRange=try c.decodeIfPresent(Double.self,forKey:.spinRange) ?? 0; xAcceleration=try c.decodeIfPresent(Double.self,forKey:.xAcceleration) ?? 0; yAcceleration=try c.decodeIfPresent(Double.self,forKey:.yAcceleration) ?? 0; color=try c.decodeIfPresent(String.self,forKey:.color) ?? "#FFFFFF"; redRange=try c.decodeIfPresent(Double.self,forKey:.redRange) ?? 0; redSpeed=try c.decodeIfPresent(Double.self,forKey:.redSpeed) ?? 0; greenRange=try c.decodeIfPresent(Double.self,forKey:.greenRange) ?? 0; greenSpeed=try c.decodeIfPresent(Double.self,forKey:.greenSpeed) ?? 0; blueRange=try c.decodeIfPresent(Double.self,forKey:.blueRange) ?? 0; blueSpeed=try c.decodeIfPresent(Double.self,forKey:.blueSpeed) ?? 0
    }
}
